  ...
  return (
    <div className="mx-auto max-w-4xl">
      ...
      <div className="mb-8 flex flex-wrap justify-center gap-3">
        <Link
          href="/admin/ceremonies/new?type=obituary"
      ...
      <section className="grid gap-4 sm:grid-cols-3">
        {[
          { href: "/admin/ceremonies", title: "葬儀一覧", desc: "作成済みの訃報・オンライン式場の確認/編集" },
          { href: "/admin/orders", title: "供花・供物 注文一覧", desc: "オンライン注文の確認・ステータス管理" },
          { href: "/admin/settings", title: "設定", desc: "供花商品・メール設定など" },
        ].map((c) => (
