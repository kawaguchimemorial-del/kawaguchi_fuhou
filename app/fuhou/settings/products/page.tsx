...
import { listProducts, getOrderSettings } from "@/lib/admin/product-actions";
import { ProductSettings } from "@/components/admin/ProductSettings";

export const dynamic = "force-dynamic";

export default async function ProductsSettings() {
  const [flowers, offerings, orderSettings] = await Promise.all([listProducts("供花"), listProducts("供物"), getOrderSettings()]);
