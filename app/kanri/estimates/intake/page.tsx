...
export default async function EstimateIntake() {
  ...
  return (
    <div className="mx-auto max-w-3xl">
      ...
      <EstimateCreateForm intakeMode defaultStaffName={staffName} products={[]} productSets={[]} osonae={[]} discounts={[]} purposes={[]} templates={[]} />
    </div>
  );
}
