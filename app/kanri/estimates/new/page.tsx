...
export default async function NewEstimate() {
  ...
  return (
    <div className="mx-auto max-w-4xl">
      ...
      <EstimateCreateWithIntake defaultStaffName={staffName} products={products} productSets={productSets} osonae={osonae} discounts={discounts} purposes={purposes} templates={templates} />
    </div>
  );
}
