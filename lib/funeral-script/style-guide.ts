...
export const funeralNarrationStyleGuide = {
  ...
  commonToneRules: [
    ...
    "取材素材は要約して並べるのではなく、その人だけの一場面として描く。趣味・職歴・活動は『何を・どこで・どんな様子で』が想像できる具体に落とす（例:『長年、庭の梅の木を丹精込めて手入れされていたそうです』のように、動作と対象を伴わせる）",
    "原則は一文一情景。ただし時間や因果でつながる場合は『〜してから』『〜ゆえに』などで自然に連ね、断片の羅列にはしない",
    "数字・肩書・年号は列挙しない。必要なものだけ一つの場面の中へ溶かす（『四十年勤め上げ』と述べるより、その仕事ぶりが伝わる一情景で示す）",
    "心の芯となる一つの挿話（最も人柄が表れるエピソード・習慣・口癖のいずれか）を決め、他の素材はその挿話を支える形で従える。全素材を等価に紹介しない",
    "感動は誇張や『お涙頂戴』では作らない。事実に根ざした具体と、言い切らずに余韻を残す結びで、静かに心が動くように綴る",
  ],
  ...
  /** メインナレーション（芯の一挿話中心・三層） */
  mainNarrationStructure: [
    "起点となる一場面を選ぶ（最も人柄が表れるエピソード・習慣・口癖・仕事ぶりのいずれか一つ）。経歴の頭からではなく、その場面から入ってよい",
    "その場面に、仕事・趣味・地域活動・功労のうち関係するものだけを従属させて厚みを出す（独立した紹介・列挙にはしない）",
    "家族との関わりは、入力にある具体的な行動・言葉・習慣があれば、それを一つ情景として描く",
    "遺影写真の由来が分かれば、その場面と響き合う形で一言だけ添える",
    "言い切らず、余韻の残る感謝と追悼で結ぶ（会葬者が故人を偲べるように）",
  ],
